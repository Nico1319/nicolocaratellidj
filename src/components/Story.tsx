...
export function Story() {
  ...
  return <section ref={sectionRef} id="story" className="py-32 bg-secondary">
      <div className="container mx-auto px-6 max-w-7xl">
        <h2 className={`text-center text-heading font-bold mb-16 transition-all duration-700 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`} style={{
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-8">
            <div className={`space-y-4 transition-all duration-700 delay-100 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`} style={{
            filter: isVisible ? "blur(0)" : "blur(10px)"
          }}>
            ...
            <button onClick={() => setShowHistory(!showHistory)} className={`inline-flex items-center gap-2 text-sm font-semibold text-primary hover:text-primary/80 transition-colors pt-4 hover:scale-[1.03] transform duration-700 delay-200 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`} style={{
            filter: isVisible ? "blur(0)" : "blur(10px)"
          }}>
            ...
            {showHistory && <div className="space-y-6 pt-8 border-t border-border/30 animate-fade-in">
          ...
          {/* Image */}
          <div className={`relative rounded-[40px] overflow-hidden shadow-2xl group hover:scale-[1.01] transition-all duration-700 delay-300 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`} style={{
          filter: isVisible ? "blur(0)" : "blur(10px)"
        }}>
            <img alt="Ritratto DJ Nicolò Caratelli" className="w-full h-full object-cover opacity-90 transition-opacity duration-500 aspect-[4/5]" src="/lovable-uploads/90186305-67f5-43a2-b0fe-5b954e08f3a9.jpg" />
