...
export function About() {
  ...
  return (
    <section ref={sectionRef} id="about" className="py-32 bg-background overflow-hidden">
      <div className="container mx-auto px-6 max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 md:grid-rows-2 gap-6 md:h-[800px]">
          ...
          <a
            ...
            style={apple3DStyles(isVisible, 350)}
          >
            <img
              alt="Total Audio"
            ...
            <div className="relative z-10 p-8 h-full flex flex-col justify-between">
              <div className="w-12 h-12 bg-foreground/10 backdrop-blur-md rounded-full flex items-center justify-center text-foreground mb-4 group-hover:scale-110 transition-transform duration-500">
          ...
          <a
            ...
            style={apple3DStyles(isVisible, 500)}
          >
            <img
            ...
            <div className="relative z-10 h-full flex flex-col justify-between p-8">
              <div className="flex justify-between items-start">
                ...
                <ArrowUpRight className="text-foreground w-6 h-6 group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform duration-300" />
              </div>
